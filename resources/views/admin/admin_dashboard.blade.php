...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4 w-1/6">
          ...
          <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
            <td class="px-4 py-3">
              <div class="flex items-center text-sm">
                ...
                <div>
                  <p class="font-semibold">Hans Zimmerman</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">Composer</p>
                </div>
              </div>
            </td>
            <td class="px-4 py-3 text-sm">P855.85</td>
          ...
          <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
            <td class="px-4 py-3">
              <div class="flex items-center text-sm">
                ...
                <div>
                  <p class="font-semibold">Joji</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">Comedian</p>
                </div>
              </div>
            </td>
            <td class="px-4 py-3 text-sm">P369.75</td>
            <td class="px-4 py-3 text-xs">
          ...
          <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
            <td class="px-4 py-3">
              <div class="flex items-center text-sm">
                ...
                <div>
                  <p class="font-semibold">Kamado Tanjiro</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">Demon Slayer</p>
                </div>
              </div>
            </td>
            <td class="px-4 py-3 text-sm">P775.45</td>
            <td class="px-4 py-3 text-xs">
          ...
          <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
            <td class="px-4 py-3">
              <div class="flex items-center text-sm">
                ...
                <div>
                  <p class="font-semibold">Monkey D. Luffy</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">Pirate</p>
                </div>
              </div>
            </td>
          ...
          <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
            <td class="px-4 py-3">
              <div class="flex items-center text-sm">
                ...
                <div>
                  <p class="font-semibold">Biscuit Oliver</p>
                  <p class="text-xs text-gray-600 dark:text-gray-400">Dentist</p>
                </div>
              </div>
            </td>
            <td class="px-4 py-3 text-sm">P863.45</td>
            <td class="px-4 py-3 text-xs">
