        ...
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white text-black dark:text-white"   style="background-color:#072870">
          ...
          <div class="fixed w-full flex items-center justify-between h-14 text-white z-10" style="background-color: #000435">
            <div class="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 border-none"  >  <!-- user div  --->
              ...
              <span class="hidden md:block">PATIENT</span>
            </div>
          ...
          <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 h-full text-white transition-all duration-300 border-none z-10 sidebar" style="background-color: #000435"><!- side bar color -->
            <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
              <ul class="flex flex-col py-4 space-y-1">
                ...
                <li>
                  <a href="{{route('home.patient')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                ...
                <li>
                  <a href="{{route('home.patientappointment')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                ...
                <li>
                  <a href="{{route('home.patientPrescription')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                ...
                <li>
                  <a href="{{route('home.patientpayment')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                ...
                <li>
                  <a href="{{route('home.patientdoctor')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
...
<div class="bg-gray-200">
  <div class="container mx-auto ">
    ...
    <form class="font-bold text-xl md:text-xl lg:text-xl bg-white">
  Which department do you need assistance from? <select STYLE="color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #1976D2;" name="doctor" id="doctor">
    <option class="text-black" value="" selected="selected">Dentistry</option>
    <option class="text-black" value="" selected="selected">Dermatology</option>
    <option class="text-black" value="" selected="selected">Ophthalmology</option>
  </select>

  <br>
  Which doctor would you love to have assist you? <select STYLE="color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #1976D2;" name="doctor" id="doctor">
    <option class="text-black" value="" selected="selected">Doctor One</option>
    <option class="text-black" value="" selected="selected">Doctor Two</option>
    <option class="text-black" value="" selected="selected">Doctor Three</option>
  </select>
<br>
  
<label for="message" class="font-bold text-xl md:text-xl lg:text-xl bg-white">Your symptoms:</label>
<textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."></textarea>

</form>
    </div>
    <button type="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 flex flex-col justify-center items-center">Book now</button>
