...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	<meta name="author" content="INTUITIVE E-HEALTHCARE">
	<meta name="keywords" content="INTUITIVE E-HEALTHCARE, bootstrap, bootstrap 5, bootstrap5, admin, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="../../pages/general/invoice.blade.php" class="nav-link">INVOICE FOR PRESCRIPTIONS</a>
                </li>
      ...
      <div class="sidebar-body">
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
            <h2 class="text-center mb-3 mt-4">Make payment</h2>
			...
			<footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between px-4 py-3 border-top small">
				<p class="text-muted mb-1 mb-md-0">Copyright © 2022 <a href="https://www.INTUITIVE E-HEALTHCARE.com" target="_blank">INTUITIVE E-HEALTHCARE</a>.</p>
