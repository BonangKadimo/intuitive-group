	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-header">
        <a href="#" class="sidebar-brand">
          INTUITVE<span>E-HEALTHCARE</span>
        </a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="../../pages/general/invoice.blade.php" class="nav-link">INVOIVE OF PRESCRIPTIONS</a>
                </li>
      ...
      <div class="sidebar-body">
		...
		<div class="page-wrapper">
			...
			<footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between px-4 py-3 border-top small">
				<p class="text-muted mb-1 mb-md-0">Copyright © 2022 <a href="https://www.INTUITIVE_E-HEALTHCARE.COM" target="_blank">INTUITIVE E-HEALTHCARE</a>.</p>
