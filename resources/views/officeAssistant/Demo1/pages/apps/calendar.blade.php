...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<meta name="keywords" content="INTUITIVE E-HEALTHCARE, bootstrap, bootstrap 5, bootstrap5, admin, dashboard, template, responsive, css, sass, html, theme, front-end, E-HEALTHCARE kit, web">
              ...
              <div class="input-group-text">
                ...
                <ul class="list-unstyled p-1">
                  <li class="dropdown-item py-2">
                    <a href="../../pages/general/profile.hblade.phptml" class="text-body ms-0">
				...
				<div class="row">
                    ...
                    <div id='external-events' class='external-events'>
                      ...
                      <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event'>
                        <div class='fc-event-main'>Boago's appointment</div>
                      </div>
                      <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event'>
                        <div class='fc-event-main'>Sethunya's appointment</div>
                      </div>
                      <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event'>
                        <div class='fc-event-main'>DR Tswai booked </div>
                      </div>
                      <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event'>
                        <div class='fc-event-main'>Dr Lili free</div>
                      </div>
                      <div class='fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event hii'>
                        <div class='fc-event-main'>Dr Michelle on leave</div>
                      </div>
                    </div>
									</div>
								</div>
