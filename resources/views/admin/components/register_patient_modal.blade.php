...
<body class="bg-gray-200 flex items-center justify-center h-screen">
  ...
  <button class="modal-open bg-transparent border border-white hover:border-indigo-500 text-white hover:text-indigo-500 font-bold py-2 px-4 rounded-full">Add Patient</button>
        ...
        <div class="text-black">
            <form action="{{url('upload_patient')}}" method="POST">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="_patient_name" placeholder="..." class="rounded-lg bg-gray-50 border-gray-300">
